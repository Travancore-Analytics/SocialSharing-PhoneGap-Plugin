...
- (void)shareViaInternal:(CDVInvokedUrlCommand*)command
    ...
    [composeViewController setCompletionHandler:^(SLComposeViewControllerResult result) {
        if (SLComposeViewControllerResultCancelled == result) {
            CDVPluginResult * pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"User cancelled the operation."];
            [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
            ...
            CDVPluginResult * pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Facebook not available"];
            [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
        }
...
- (void)shareViaEmail:(CDVInvokedUrlCommand*)command {
    if ([self isEmailAvailable]) {
        ...
        CDVPluginResult * pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_ERROR messageAsString:@"Email not available"];
        [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
    }
}
